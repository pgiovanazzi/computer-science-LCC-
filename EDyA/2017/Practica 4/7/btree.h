...
/**
 * Calcula la suma de los elementos de un arbol de enteros.
 */
int btree_suma_elementos(BTree arbol);

/**
 * Cuenta la cantidad de nodos de un arbol de enteros.
 */
...
/**
 * Recorre el arbol, utilizando una funcion pasada y una variable puntero a
 * void.
 */
