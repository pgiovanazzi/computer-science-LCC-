...
/**
 * Si el elemento esta en la lista devuelve la posicion del mismo. complejidad
 * o(n*n)
*/
...
/**
 * Devuelve una lista con los elementos comunes, (independientemente de la
 * posicion). No se modifican las listas.complejidad o(n*n)
*/

GList glist_intersect(GList l1, GList l2);

/**
 * Trabaja de la misma forma que la funcion anterior a difierencia que recibe un
 * parametro extra, un puntero
 * a una funcion de comparacion que define la nocion de igualdad al ser usada al
 * comparar elementos por igualdad.complejidad o(n*n)
*/

GList glist_intersect_custom(GList l1, GList l2, FComp fun);

/**
 * Ordena la lista de acuerdo a un criterio dado por una funcion de
 * comparacion.complejidad o(n*n)
*/
