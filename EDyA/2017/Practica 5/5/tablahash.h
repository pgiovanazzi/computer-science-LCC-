 ...
 */
typedef unsigned (*FuncionHash)(void *clave, unsigned sz, unsigned iter);
/**
...
// Simbolo de eliminacion.
static char SIM_ELIM = '-';

/**
 * Crea una nueva tabla Hash vacía, con la capacidad dada.
 */
TablaHash *tablahash_crear(unsigned capacidad, FuncionHash fun, FuncionIgualdad funIn);
