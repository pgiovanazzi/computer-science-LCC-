...
/**
 * dadas dos listas, intercale sus elementos en la lista resultante. Por
 * ejemplo,
 * dadas las listas [1, 2, 3, 4] y [5, 6], debe obtener la lista [1, 5, 2, 6, 3,
 * 4].
 */
...
/**
 * Parte la lista a la mitad y devuelve dos sublistas (guardadas en res1 y
 * res2).
 */
